...
$pdf->ln(5);
$pdf->SetFont('Arial','B',14);
$pdf->cell(128,5,'VOUCHER',0,1,'C');
$pdf->SetFont('Arial','',14);
$pdf->cell(60,5,'Voucher: '.$det['series']."-",0,0,'L');
...
$pdf->Multicell(120,7,'Paid to: '. ucwords(strtolower($det['name'].', '.$det['add1'])),0,'L');
$pdf->ln(1);
...
$pdf->SetFont('Times','',13);
$pdf->Multicell(118,5,'Vide '.($det['mop']=="Cash"?$det['mop']:ucfirst($det['mop']). ": ").($det['chno']!==''?"No: ".$det['chno']:'')." ".(($det['chdate']!=='' and $det['chdate']!=='0000-00-00')?'Dt: '.$det['chdate']:'')." ".ucfirst($det['remark']),0,'L');
...
$pdf->ln(10);
$pdf->cell(118,5,"Receiver's Signature",0,1,'R');
$pdf->ln(50);
